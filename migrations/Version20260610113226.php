 ...
 */
final class Version20260610113226 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE doctrine_migration_versions (
              version VARCHAR(191) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_german2_ci`,
              executed_at DATETIME DEFAULT 'NULL',
              execution_time INT DEFAULT NULL,
              PRIMARY KEY (version)
            ) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_german2_ci` ENGINE = InnoDB COMMENT = ''
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE
              flaggenstaaten
